                              ...
                              child: Container(
                                  ...
                                  child: Stack(alignment: Alignment.topCenter, children: [
                                    Align(
                                        ...
                                        child: Padding(
                                            padding: getPadding(left: 18, top: 84),
                                    ...
                                    CustomImageView(
                                        ...
                                        margin: getMargin(left: 71, bottom: 50)),
                                    Align(
                                        alignment: Alignment.topLeft,
                                        child: Container(
                                            margin: getMargin(left: 18, top: 195),
                                                    ...
                                                    Align(
                                                        ...
                                                        child: Container(
                                                            ...
                                                            child: Stack(alignment: Alignment.bottomCenter, children: [
                                                              CustomImageView(
                                                                  svgPath: ImageConstant.imgTrash, height: getVerticalSize(30.00), width: getHorizontalSize(54.00), alignment: Alignment.center),
                                                              Align(
                                            ...
                                            child: Container(
                                                ...
                                                child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.end, children: [
                                                  Align(
                                                      ...
                                                      child: Padding(
                                                          padding: getPadding(top: 235, right: 113),
                                                          child: Text("lbl_melayu".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtPoppinsMedium18Bluegray900))),
                                                  Padding(
                                                      padding: getPadding(top: 3, right: 68),
                                    ...
                                    Align(
                                        ...
                                        child: GestureDetector(
                                            ...
                                            child: Container(
                                                margin: getMargin(left: 24, top: 598, right: 24, bottom: 242),
                                                padding: getPadding(all: 10),
                                                decoration: AppDecoration.fillWhiteA700.copyWith(borderRadius: BorderRadiusStyle.roundedBorder18),
                                                child: Row(children: [
                                                  CustomImageView(
                                                      imagePath: ImageConstant.imgImage11, height: getSize(70.00), width: getSize(70.00), radius: BorderRadius.circular(getHorizontalSize(18.00))),
                                                  Padding(
                                                      padding: getPadding(left: 16, top: 10, right: 20, bottom: 9),
                                                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                        Text("msg_jenazah_di_bali".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtPoppinsMedium18Bluegray900),
                                                        Padding(
                                                            padding: getPadding(top: 2),
                                                            child: Text("lbl_17_januari_2023".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtPoppinsLight14))
                                                      ]))
                                                ])))),
                                    Align(
                                        alignment: Alignment.bottomCenter,
                                        child: GestureDetector(
                                            ...
                                            child: Container(
                                                margin: getMargin(left: 24, top: 704, right: 24, bottom: 136),
                                                padding: getPadding(all: 10),
                                                decoration: AppDecoration.fillWhiteA700.copyWith(borderRadius: BorderRadiusStyle.roundedBorder18),
                                                child: Row(children: [
                                                  Container(
                                                  ...
                                                  Padding(
                                                      padding: getPadding(left: 16, top: 7, right: 29, bottom: 9),
                                                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                        Text("msg_pemakaman_modern".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtPoppinsMedium18Bluegray900),
                                                        Padding(
                                                            padding: getPadding(top: 4),
                                                            child: Text("lbl_1_februari_2023".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtPoppinsLight14))
                                                      ]))
                                                ])))),
                                    Align(
                                        alignment: Alignment.bottomCenter,
                                        child: GestureDetector(
                                            ...
                                            child: Container(
                                                margin: getMargin(left: 24, top: 810, right: 24, bottom: 30),
                                                padding: getPadding(left: 8, top: 10, right: 8, bottom: 10),
                                                decoration: AppDecoration.fillWhiteA700.copyWith(borderRadius: BorderRadiusStyle.roundedBorder18),
                                                child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                                  CustomImageView(
                                                      imagePath: ImageConstant.imgImage9, height: getSize(70.00), width: getSize(70.00), radius: BorderRadius.circular(getHorizontalSize(18.00))),
                                                  Padding(
                                                      padding: getPadding(left: 16, top: 7, bottom: 9),
                                                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                        Text("msg_peresmian_tanah".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtPoppinsMedium18Bluegray900),
                                                        Padding(
                                                            padding: getPadding(top: 4),
                                                            child: Text("msg_17_februari_2023".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtPoppinsLight14))
                                                      ]))
                                                ])))),
                                    Align(
                                        alignment: Alignment.bottomLeft,
                                        child: Padding(
                                            padding: getPadding(left: 24, bottom: 348),
                                        ...
                                        child: Container(
                                            ...
                                            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                    ...
                                                    CustomAppBar(
                                                        ...
                                                        title: Container(
                                                            ...
                                                            child: Stack(children: [
                                                              AppbarImage(height: getVerticalSize(110.00), width: getHorizontalSize(195.00), imagePath: ImageConstant.imgRectangle2735),
                                                              Padding(
                                                                  ...
                                                                  child: Column(mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                    CustomImageView(
                                                                        ...
                                                                        radius: BorderRadius.circular(getHorizontalSize(27.00)),
                                                                        margin: getMargin(left: 6, right: 4)),
                                                                    Text("lbl_bunda".tr,
                                                                        overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtPoppinsMedium18.copyWith(letterSpacing: 0.18))
                                                                  ]))
                                                            ])))
                                                  ])),
                                              GestureDetector(
                                                  ...
                                                  child: Padding(
                                                      ...
                                                      child: Row(children: [
                                                        CustomImageView(svgPath: ImageConstant.imgHome20x20, height: getSize(20.00), width: getSize(20.00)),
                                                        Padding(
                                                            padding: getPadding(left: 10, top: 2),
                                                            child: Text("lbl_beranda".tr,
                                                                overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtPoppinsRegular11.copyWith(letterSpacing: 0.55)))
                                                      ]))),
                                              GestureDetector(
                                                  onTap: () {
                                                    onTapRowcomputer();
                                                  ...
                                                  child: Padding(
                                                      ...
                                                      child: Row(children: [
                                                        CustomImageView(svgPath: ImageConstant.imgComputer, height: getVerticalSize(21.00), width: getHorizontalSize(20.00)),
                                                        Padding(
                                                            padding: getPadding(left: 10, top: 1, bottom: 3),
                                              ...
                                              Padding(
                                                  ...
                                                  child: Row(children: [
                                                    CustomImageView(
                                                        svgPath: ImageConstant.imgComputer21x20,
                                                    ...
                                                    GestureDetector(
                                                        ...
                                                        child: Padding(
                                                            padding: getPadding(left: 10, top: 2, bottom: 2),
                                                            child: Text("lbl_artikel".tr,
                                                                overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtPoppinsRegular11.copyWith(letterSpacing: 0.55))))
                                                  ])),
                                              Padding(
                                                  padding: getPadding(left: 27, top: 21, right: 91),
                                                  child: Obx(() => ListView.builder(
                                                      physics: NeverScrollableScrollPhysics(),
                                                      shrinkWrap: true,
                                                      itemCount: controller.sideMenuModelObj.value.sideMenuItemList.length,
                                                      itemBuilder: (context, index) {
                                                        SideMenuItemModel model = controller.sideMenuModelObj.value.sideMenuItemList[index];
                                                        return SideMenuItemWidget(model, onTapRoweye: onTapRoweye);
                                                      }))),
                                              GestureDetector(
                                                  onTap: () {
                                                    onTapRowinfo();
                                                  ...
                                                  child: Padding(
                                                      ...
                                                      child: Row(children: [
                                                        CustomImageView(svgPath: ImageConstant.imgInfo23x22, height: getVerticalSize(23.00), width: getHorizontalSize(22.00)),
                                                        Padding(
                                                            padding: getPadding(left: 9, top: 4, bottom: 2),
                                                            child: Text("lbl_tentang".tr,
                                                                overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtPoppinsRegular11.copyWith(letterSpacing: 0.55)))
                                                      ]))),
                                              GestureDetector(
                                                  onTap: () {
                                                  ...
                                                  child: Padding(
                                                      padding: getPadding(left: 25, top: 21),
                                                      child: Row(children: [
                                                        CustomImageView(svgPath: ImageConstant.imgMinimize, height: getVerticalSize(21.00), width: getHorizontalSize(20.00)),
                                                        Padding(
                                                            padding: getPadding(left: 10, bottom: 4),
                                                            child: Text("lbl_keluar".tr,
                                                                overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtPoppinsRegular11Red400.copyWith(letterSpacing: 0.55)))
                                                      ]))),
                                              Padding(
                                                  padding: getPadding(left: 16, top: 495, bottom: 7),
                                                  child: Text("lbl_versi_1_0".tr,
                                                      overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtPoppinsRegular11.copyWith(letterSpacing: 0.55)))
                                            ]))),
                                    Align(
                                        alignment: Alignment.topRight,
                                                            ...
                                                            Align(
                                                                ...
                                                                child: Container(
                                                                    ...
                                                                    child: Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                                                                      CustomImageView(
                                                                          svgPath: ImageConstant.imgStar124x24,
                                                                      ...
                                                                      Padding(
                                                                          ...
                                                                          child: Text("lbl_4_8".tr,
                                                                              overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtPoppinsMedium14Bluegray900))
                                                                    ])))
                                                          ])))
                                                ]))))
                                  ])))
