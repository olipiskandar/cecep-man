                                                    ...
                                                    GestureDetector(
                                                        ...
                                                        child: Card(
                                                            ...
                                                            child: Container(
                                                                ...
                                                                child: Stack(children: [
                                                                  CustomImageView(
                                                                      svgPath: ImageConstant.imgArrowrightWhiteA70024x24, height: getSize(24.00), width: getSize(24.00), alignment: Alignment.topCenter)
                                                                ])))),
                                                    CustomImageView(svgPath: ImageConstant.imgGroup1411, height: getVerticalSize(35.00), width: getHorizontalSize(109.00)),
                                                    GestureDetector(
                                                        onTap: () {
