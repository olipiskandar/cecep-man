...
import 'package:apzah_app/widgets/custom_drop_down.dart';
                                  ...
                                  child: Container(
                                      ...
                                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                                        ...
                                        CustomTextFormField(
                                            width: 315,
                                            focusNode: FocusNode(),
                                            controller: controller.textInputEmailOneController,
                                        ...
                                        CustomTextFormField(
                                            width: 315,
                                            focusNode: FocusNode(),
                                            controller: controller.textInputEmailTwoController,
                                        ...
                                        CustomTextFormField(
                                            width: 315,
                                            focusNode: FocusNode(),
                                            controller: controller.textInputEmailThreeController,
                                        ...
                                        CustomDropDown(
                                            width: 315,
                                            focusNode: FocusNode(),
                                            icon: Container(margin: getMargin(left: 30, right: 22), child: CustomImageView(svgPath: ImageConstant.imgVector)),
                                            hintText: "lbl_jenis_kelamin".tr,
                                            margin: getMargin(top: 12),
                                            items: controller.registerModelObj.value.dropdownItemList,
                                            prefix: Container(margin: getMargin(left: 17, top: 14, right: 17, bottom: 17), child: CustomImageView(svgPath: ImageConstant.imgUser)),
                                            prefixConstraints: BoxConstraints(minWidth: getSize(18.00), minHeight: getSize(18.00)),
                                            onChanged: (value) {
                                        ...
                                        CustomDropDown(
                                            ...
                                            focusNode: FocusNode(),
                                            icon: Container(margin: getMargin(left: 30, right: 22), child: CustomImageView(svgPath: ImageConstant.imgVector)),
                                            hintText: "lbl_aktivitas".tr,
                                            margin: getMargin(top: 12),
                                            items: controller.registerModelObj.value.dropdownItemList1,
                                            prefix: Container(margin: getMargin(left: 17, top: 14, right: 17, bottom: 17), child: CustomImageView(svgPath: ImageConstant.imgUser)),
                                            prefixConstraints: BoxConstraints(minWidth: getSize(18.00), minHeight: getSize(18.00)),
                                            onChanged: (value) {
                                        ...
                                        Obx(() => CustomTextFormField(
                                            width: 315,
                                            focusNode: FocusNode(),
                                            controller: controller.textInputEmailSixController,
                                            hintText: "lbl_password".tr,
                                            margin: getMargin(top: 14),
                                            padding: TextFormFieldPadding.PaddingT14_1,
                                            textInputAction: TextInputAction.done,
                                            prefix: Container(margin: getMargin(all: 17), child: CustomImageView(svgPath: ImageConstant.imgLock)),
                                        ...
                                        GestureDetector(
                                            ...
                                            child: Padding(
                                                padding: getPadding(left: 57, top: 36, bottom: 19),
                                                child: RichText(
