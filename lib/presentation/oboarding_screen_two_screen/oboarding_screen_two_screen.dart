                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                      ...
                      Container(
                          ...
                          child: Stack(alignment: Alignment.topLeft, children: [
                            ...
                            CustomImageView(
                                svgPath: ImageConstant.imgFilter, height: getVerticalSize(97.00), width: getHorizontalSize(16.00), alignment: Alignment.topLeft, margin: getMargin(left: 78),),
                            CustomImageView(
                            ...
                            CustomImageView(
                                svgPath: ImageConstant.imgMail, height: getVerticalSize(45.00), width: getHorizontalSize(29.00), alignment: Alignment.topLeft, margin: getMargin(left: 28, top: 68),),
                            CustomImageView(
                                svgPath: ImageConstant.imgLightbulb, height: getVerticalSize(65.00), width: getHorizontalSize(49.00), alignment: Alignment.topLeft, margin: getMargin(left: 10),),
                            CustomImageView(
                            ...
                            Align(
                                ...
                                child: Container(
                                    ...
                                    child: Stack(children: [
                                      CustomImageView(
                                          svgPath: ImageConstant.imgFreepikcharacterinject2, height: getVerticalSize(114.00), width: getHorizontalSize(63.00), alignment: Alignment.centerRight,)
                                    ],),),),
                            Align(
                          ...
                          child: Container(
                              ...
                              child: SmoothIndicator(
                                  ...
                                  effect: ScrollingDotsEffect(
                                      spacing: 15, activeDotColor: ColorConstant.whiteA700, dotColor: ColorConstant.gray400, dotHeight: getVerticalSize(10.00), dotWidth: getHorizontalSize(18.00),),),),),
                      Align(
                          alignment: Alignment.centerRight,
                          child: GestureDetector(
                              onTap: () {
