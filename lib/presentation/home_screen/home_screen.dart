    ...
    return SafeArea(
        child: Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                leadingWidth: 53,
                leading: AppbarImage(height: getSize(35.00), width: getSize(35.00), svgPath: ImageConstant.imgMenu, margin: getMargin(left: 18, top: 3, bottom: 18), onTap: onTapMenu1),
                actions: [AppbarCircleimage1(imagePath: ImageConstant.imgEllipse592, margin: getMargin(left: 25, top: 3, right: 25, bottom: 3), onTap: onTapEllipse593)]),
            body: Container(
                width: size.width,
                height: size.height,
                ...
                child: SingleChildScrollView(
                    child: Padding(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                          Text("lbl_hai_bunda".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtPoppinsMedium22.copyWith(letterSpacing: 0.22)),
                          Container(
                          ...
                          Padding(
                              padding: getPadding(left: 6, top: 16, right: 24),
