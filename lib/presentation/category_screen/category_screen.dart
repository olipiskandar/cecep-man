    ...
    return SafeArea(
        child: Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                leadingWidth: 53,
                leading: AppbarImage(height: getSize(35.00), width: getSize(35.00), svgPath: ImageConstant.imgMenu, margin: getMargin(left: 18, top: 2, bottom: 23), onTap: onTapMenu2),
                actions: [AppbarCircleimage(imagePath: ImageConstant.imgEllipse592, margin: getMargin(left: 32, right: 32), onTap: onTapEllipse594)]),
            body: Container(
                width: size.width,
                height: size.height,
